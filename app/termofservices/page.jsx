...
export const metadata = {
    title: "Term of Services | Pharma Join",
    description:
...
const page = () => {
  return (
    <div className="container mx-auto">
      ...
      <p>
          Disclaimer for PharmaJoin If you require any more information or have
          any questions about our site's disclaimer, please feel free to contact us
          by email at pharmajoin9@gmail.com.
      </p> 
      <p>
            Disclaimers for Pharmajoin All the information on this website is published in good faith and for general
          information purpose only. Pharmajoin does not make any warranties about
          the completeness, reliability and accuracy of this information. Any action
          you take upon the information you find on this website (pharmajoin.in), is
          strictly at your own risk. will not be liable for any losses and/or
          ...
          may have gone ‘bad'. Please be also aware that when you leave our website,
          other sites may have different privacy policies and terms which are beyond
          our control. Please be sure to check the Privacy Policies of these sites
          as well as their "Terms of Service" before engaging in any business or
          uploading any information. Consent By using our website, you hereby
          consent to our disclaimer and agree to its terms. Update Should we update,
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to pharma join.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to pharma join, accessible from{" "}
            <a
      ...
      <h2 className="text-xl">Acknowledgment</h2>
      <p>
      ...
      <h2 className="text-xl">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
      <p>
      ...
      <h2 className="text-xl">Disputes Resolution</h2>
      <p>
      ...
      <h2 className="text-xl">For European Union (EU) Users</h2>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which You are
        resident.
      </p>
      <h2 className="text-xl">United States Legal Compliance</h2>
      <p>
      ...
      <h2 className="text-xl">Severability and Waiver</h2>
      ...
      <h2 className="text-xl">Translation Interpretation</h2>
      <p>
      ...
      <h2 className="text-xl">Changes to These Terms and Conditions</h2>
      <p>
      ...
      <ul>
       <a href="mailto:pharmajoin9@gmail.com">pharmjoin9@gmail.com</a>
      </ul>
