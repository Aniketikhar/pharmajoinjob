  ...
  return (
    <>
      <div className="container mx-auto font-sans">
        <h1 className="text-center text-4xl">Pivacy Policies</h1>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Pharma Join.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                <a
                  href="http://www.pharmajoin.in"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  http://www.pharmajoin.in
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>
                ...
                <a
                  ...
                  class="__cf_email__"
                  data-cfemail="cfbfa7aebda2aea5a0a6a1f68fa8a2aea6a3e1aca0a2"
                >
            ...
            <li>
              <p>
                ...
                <a
                  href="https://pharmajoin.in/contact"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://pharmajoin.in/contact
                </a>
              </p>
            </li>
          </ul>
