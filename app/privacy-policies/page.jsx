...
const AboutUs = () => {
  ...
  return (
    <>
      <div className="p-5 max-w-screen-xl mx-auto shadow-xl">
        <h1 className="text-3xl font-bold mb-4">
          Welcome to Pharmajoin.in – Your Gateway to the Indian Pharmaceutical
          Industry
        </h1>
        <h2 className="text-3xl font-bold bg-blue-600 text-white text-center p-2">
          Privacy Policy
        </h2>
