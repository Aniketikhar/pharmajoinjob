...
const Header = () => {
  ...
  return (
    <nav className="pt-3">
        ...
        <div className="bg-blue-800 ">
          ...
          >
            ...
            <button
              ...
              className={`${
                active == "All Categories" ? "bg-blue-600 underline" : ""
            ...
            {categories?.map((category, index) => (
              <button
                ...
                className={`${
                  active == category.name ? "bg-blue-600 underline" : ""
      ...
      <div className="fixed top-[60%] right-0 p-4">
        <ul className="example-2">
          ...
          <li className="icon-content">
            ...
            >
              <img src={assets.whatsapp.src} className="" alt="" />
            </a>
          ...
          <li className="icon-content">
            ...
            >
              ...
              <img src={assets.telegram.src} alt="" />
            </a>
